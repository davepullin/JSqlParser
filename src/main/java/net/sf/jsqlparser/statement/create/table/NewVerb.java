...
public class NewVerb implements Statement {
    ...
    public NewVerb withTable(Table table) {
        this.setTable(table);
        return this;
    }

    public NewVerb withUnlogged(boolean unlogged) {
        this.setUnlogged(unlogged);
        return this;
    }

    public NewVerb withCreateOptionsStrings(List<String> createOptionsStrings) {
        this.setCreateOptionsStrings(createOptionsStrings);
        return this;
    }

    public NewVerb withSelectParenthesis(boolean selectParenthesis) {
        this.setSelectParenthesis(selectParenthesis);
        return this;
    }

    public NewVerb withIfNotExists(boolean ifNotExists) {
        this.setIfNotExists(ifNotExists);
        return this;
    }

    public NewVerb withRowMovement(RowMovement rowMovement) {
        this.setRowMovement(rowMovement);
        return this;
    }

    public NewVerb withTableOptionsStrings(List<String> tableOptionsStrings) {
        this.setTableOptionsStrings(tableOptionsStrings);
        return this;
    }

    public NewVerb withColumnDefinitions(List<ColumnDefinition> columnDefinitions) {
        this.setColumnDefinitions(columnDefinitions);
        return this;
    }

    public NewVerb withIndexes(List<Index> indexes) {
        this.setIndexes(indexes);
        return this;
    }

    public NewVerb addCreateOptionsStrings(String... createOptionsStrings) {
    ...
    public NewVerb addCreateOptionsStrings(Collection<String> createOptionsStrings) {
        List<String> collection = Optional.ofNullable(getCreateOptionsStrings())
                .orElseGet(ArrayList::new);
    ...
    public NewVerb addColumnDefinitions(ColumnDefinition... columnDefinitions) {
    ...
    public NewVerb addColumnDefinitions(Collection<? extends ColumnDefinition> columnDefinitions) {
        List<ColumnDefinition> collection = Optional.ofNullable(getColumnDefinitions())
                .orElseGet(ArrayList::new);
    ...
    public NewVerb addIndexes(Index... indexes) {
    ...
    public NewVerb addIndexes(Collection<? extends Index> indexes) {
        List<Index> collection = Optional.ofNullable(getIndexes())
                .orElseGet(ArrayList::new);

...
public class RecreateTable implements Statement {
    ...
    public String toString() {
        ...
        sql = "RECREATE " + (unlogged ? "UNLOGGED " : "")
    ...
    public RecreateTable withTable(Table table) {
        this.setTable(table);
        return this;
    }

    public RecreateTable withUnlogged(boolean unlogged) {
        this.setUnlogged(unlogged);
        return this;
    }

    public RecreateTable withCreateOptionsStrings(List<String> createOptionsStrings) {
        this.setCreateOptionsStrings(createOptionsStrings);
        return this;
    }

    public RecreateTable withSelectParenthesis(boolean selectParenthesis) {
        this.setSelectParenthesis(selectParenthesis);
        return this;
    }

    public RecreateTable withIfNotExists(boolean ifNotExists) {
        this.setIfNotExists(ifNotExists);
        return this;
    }

    public RecreateTable withRowMovement(RowMovement rowMovement) {
        this.setRowMovement(rowMovement);
        return this;
    }

    public RecreateTable withTableOptionsStrings(List<String> tableOptionsStrings) {
        this.setTableOptionsStrings(tableOptionsStrings);
        return this;
    }

    public RecreateTable withColumnDefinitions(List<ColumnDefinition> columnDefinitions) {
        this.setColumnDefinitions(columnDefinitions);
        return this;
    }

    public RecreateTable withIndexes(List<Index> indexes) {
        this.setIndexes(indexes);
        return this;
    }

    public RecreateTable addCreateOptionsStrings(String... createOptionsStrings) {
    ...
    public RecreateTable addCreateOptionsStrings(Collection<String> createOptionsStrings) {
        List<String> collection = Optional.ofNullable(getCreateOptionsStrings())
                .orElseGet(ArrayList::new);
    ...
    public RecreateTable addColumnDefinitions(ColumnDefinition... columnDefinitions) {
    ...
    public RecreateTable addColumnDefinitions(Collection<? extends ColumnDefinition> columnDefinitions) {
        List<ColumnDefinition> collection = Optional.ofNullable(getColumnDefinitions())
                .orElseGet(ArrayList::new);
    ...
    public RecreateTable addIndexes(Index... indexes) {
    ...
    public RecreateTable addIndexes(Collection<? extends Index> indexes) {
        List<Index> collection = Optional.ofNullable(getIndexes())
                .orElseGet(ArrayList::new);

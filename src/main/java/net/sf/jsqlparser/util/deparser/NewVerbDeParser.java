 ...
 * {@link net.sf.jsqlparser.statement.create.table.NewVerb}
 */
public class NewVerbDeParser {
    ...
    public void deParse(NewVerb createTable) {
        ...
        if (createTable.getSelect() != null) {
            ...
            buffer.append(createTable.getSelect()
                    .toString());
            if (createTable.isSelectParenthesis()) {
                buffer.append(")");
            }
